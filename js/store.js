...
(function () {
  ...
  const seed = {
    ...
    // נתוני דמו בלבד (שמות/טלפונים פיקטיביים). הנתונים האמיתיים חיים ב-Supabase בלבד.
    users: [
      { id: 1, name: 'מנהל דוגמה', phone: '050-0000001', password: '050-0000001', role: 'מנהל' },
      { id: 2, name: 'מחנך דוגמה א׳', phone: '050-0000002', password: '050-0000002', role: 'מחנך' },
      { id: 3, name: 'מחנך דוגמה ב׳', phone: '050-0000003', password: '050-0000003', role: 'מחנך' },
      { id: 4, name: 'מחנך דוגמה ג׳', phone: '050-0000004', password: '050-0000004', role: 'מחנך' },
      { id: 5, name: 'מחנך דוגמה ד׳', phone: '050-0000005', password: '050-0000005', role: 'מחנך' },
      { id: 6, name: 'מחנך דוגמה ה׳', phone: '050-0000006', password: '050-0000006', role: 'מחנך' },
      { id: 7, name: 'מחנך דוגמה ו׳', phone: '050-0000007', password: '050-0000007', role: 'מחנך' },
      { id: 8, name: 'מלמד דוגמה א׳', phone: '050-0000008', password: '050-0000008', role: 'מלמד' },
      { id: 9, name: 'מלמד דוגמה ב׳', phone: '050-0000009', password: '050-0000009', role: 'מלמד' },
      { id: 10, name: 'מפקח דוגמה', phone: '050-0000010', password: '050-0000010', role: 'מפקח' },
      { id: 11, name: 'מזכירה דוגמה', phone: '050-0000011', password: '050-0000011', role: 'מזכירה' },
    ],
    user_class_access: [
  ...
  // מחיקה לפי התאמת עמודות — לטבלאות ללא עמודת id (מפתח מורכב), למשל user_class_access
