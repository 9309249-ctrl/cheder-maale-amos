...
const ASSETS = ['./', 'index.html', 'css/main.css', 'manifest.webmanifest', 'favicon.svg', 'icon-192.png',
  'js/config.js', 'js/supabase.js', 'js/api.js', 'js/store.js', 'js/ui.js', 'js/auth.js', 'js/author.js',
  'js/students.js', 'js/picker.js', 'js/behavior.js', 'js/tracking.js', 'js/dashboard.js',
  'vendor/html2canvas.min.js', 'vendor/jspdf.umd.min.js', 'js/pdf.js', 'js/exporter.js', 'vendor/xlsx-lite.js', 'js/labels.js',
  'js/admin.js', 'js/cashbox.js', 'js/forms.js', 'js/teacher.js', 'js/tasks.js',
  'js/calendar.js', 'js/staffcard.js', 'js/guide-data.js', 'js/help.js', 'js/yemot.js', 'js/voicereports.js',
  'js/reading-assess.js', 'js/certificate.js', 'js/ai-assistant.js', 'js/app.js',
